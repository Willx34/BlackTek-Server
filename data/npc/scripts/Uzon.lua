...
addTravelKeyword('farmine', 'Do you seek a ride to Farmine for free?', 0, Position(32983, 31539, 1), function(player) return player:getStorageValue(Storage.TheNewFrontier.Mission10) ~= 1 end)
addTravelKeyword('edron', 'Do you seek a ride to Edron for free?', 0, Position(33193, 31783, 3), nil, function(player) if player:getStorageValue(Storage.postman.Mission01) == 2 then player:setStorageValue(Storage.postman.Mission01, 3) end end)
addTravelKeyword('darashia', 'Do you seek a ride to Darashia on Darama for free?', 0, Position(33270, 32441, 6))
addTravelKeyword('svargrond', 'Do you seek a ride to Svargrond for free?', 0, Position(32253, 31097, 4))
addTravelKeyword('kazordoon', 'Do you seek a ride to Kazordoon for free?', 0, Position(32588, 31942, 0))
