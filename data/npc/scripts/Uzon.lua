...
addTravelKeyword('farmine', 'Do you seek a ride to Farmine for |TRAVELCOST|?', 0, Position(32983, 31539, 1), function(player) return player:getStorageValue(PlayerStorageKeys.TheNewFrontier.Mission10) ~= 1 end)
addTravelKeyword('edron', 'Do you seek a ride to Edron for |TRAVELCOST|?', 0, Position(33193, 31783, 3), nil, function(player) if player:getStorageValue(PlayerStorageKeys.postman.Mission01) == 2 then player:setStorageValue(PlayerStorageKeys.postman.Mission01, 3) end end)
