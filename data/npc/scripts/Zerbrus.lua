...
FocusModule:addGreetMessage({'hi'}, {npcHandler = npcHandler, text = 'Greetings, |PLAYERNAME|! You\'re looking really bad. Let me heal your wounds.'},
...
FocusModule:addGreetMessage({'hi'}, {npcHandler = npcHandler, text = '<nods> At your service, |PLAYERNAME|, protecting the {village} from {monsters}.'}, function(player) return player:getSex() == PLAYERSEX_FEMALE end)
-- keywordHandler:addAliasKeyword({'hello'})

FocusModule:addFarewellMessage({'bye'}, {npcHandler = npcHandler, text = 'Bye, |PLAYERNAME|.'})
