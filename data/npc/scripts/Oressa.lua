...
FocusModule:addGreetMessage({'hi'}, {npcHandler = npcHandler, text = 'Hello, |PLAYERNAME|! You are looking really bad. Let me heal your wounds. It\'s my job after all.'},
...
FocusModule:addGreetMessage({'hi'}, {npcHandler = npcHandler, text = 'Hello, |PLAYERNAME|! I\'ll {heal} you if you are injured or poisoned. Feel free to ask me for {help} or general {hints}.'}, function(player) return player:getSex() == PLAYERSEX_FEMALE end)
-- keywordHandler:addAliasKeyword({'hello'})

FocusModule:addFarewellMessage({'bye'}, {npcHandler = npcHandler, text = 'Farewell, |PLAYERNAME|!'})
