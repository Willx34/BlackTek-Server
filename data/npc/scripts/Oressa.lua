...
-- Basic keywords
-- BUG: the fix for heal somehow breaks this
...
function creatureSayCallback(cid, type, msg)
	...
	if (msgcontains(msg, 'heal')) then
		...
		if (player:getHealth() < 65) then        
			player:addHealth(65 - player:getHealth())
		...
		if healed then
			...
			npcHandler:say('You aren\'t looking really bad, '.. name ..'. I can only help in cases of real emergencies. Raise your health simply by eating food.', cid)
		end
	end
