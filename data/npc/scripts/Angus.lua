...
local function creatureSayCallback(cid, type, msg)
	...
	elseif msgcontains(msg, "farmine") then
		if player:getStorageValue(PlayerStorageKeys.TheNewFrontier.Questline) <= 15 and player:getStorageValue(PlayerStorageKeys.TheNewFrontier.BribeExplorerSociety) < 1 then
