...
npcHandler:setMessage(MESSAGE_SENDTRADE, 'Take a look in the trade window to your right.')
...
-- HACK: cant have multiple greet messages
npcHandler:setMessage(MESSAGE_GREET,
	'Hello, hello, |PLAYERNAME|! Please come in, look, and buy! I\'m a specialist for all sorts of {tools}. Just ask me for a {trade} to see my offers! You can also ask me for general {hints} about the game. You can also ask me about each {citizen} of the isle.'
)
