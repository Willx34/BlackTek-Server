...
local function creatureSayCallback(cid, type, msg)
	...
	if msgcontains(msg, "mission") then
		...
		elseif player:getStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission73) == 1 then--and player:getStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission74) < 1 then
			npcHandler:say({
			...
			player:setStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission73, 2)
	...
	elseif msgcontains(msg, "yes") then
		...
		elseif player:getStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission70) == 1 and player:getStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission71) < 1 then
			...
			player:setStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission69, 1)
		elseif npcHandler.topic[cid] == 15 and player:getStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission69) == 1 and player:getStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission72) < 1 then
			if player:removeItem(21250, 1) then
		...
		elseif npcHandler.topic[cid] == 17 and player:getStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission73) == 1 and player:getStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission74) < 1 then
			npcHandler:say({
	...
	elseif msgcontains(msg, 'restore') and player:getStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission69) <= 1 and player:getStorageValue(PlayerStorageKeys.GravediggerOfDrefia.Mission73) < 1 then --and npcHandler.topic[cid] == 15 then
