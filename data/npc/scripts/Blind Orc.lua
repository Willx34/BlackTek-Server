...
FocusModule:addGreetMessage({'charach'}, {npcHandler = npcHandler, text = 'Ikem Charach maruk.'})
FocusModule:addFarewellMessage({'futchi'}, {npcHandler = npcHandler, text = 'Futchi!'})
