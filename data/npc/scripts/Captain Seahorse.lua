...
addTravelKeyword('venore', 0, Position(32954, 32022, 6), function(player) if player:getStorageValue(PlayerStorageKeys.postman.Mission01) == 3 then player:setStorageValue(PlayerStorageKeys.postman.Mission01, 4) end end)
