...
-- HACK: just teleport to final version of farmine
addTravelKeyword('farmine', {'Do you seek a ride to Farmine for free?', 'Hold on!', 'You shouldn\'t miss the experience.'}, 0, {'postman', 'new frontier'}, Position(33025, 31553, 10))
--[[
addTravelKeyword('farmine', {'Do you seek a ride to Farmine for free?', 'Hold on!', 'You shouldn\'t miss the experience.'}, 0, {'postman', 'new frontier'},
	function(player)
...
addTravelKeyword('kazordoon', {'Do you want to go to Kazordoon to try the beer there? 0 gold coins?', 'Set the sails!', 'Then not.'}, 0, 'postman', Position(32660, 31957, 15))
